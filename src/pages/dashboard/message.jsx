...
import { Toaster, toast } from "react-hot-toast"; // Imported react-hot-toast
...
const MessagesPage = () => {
  ...
  const handleReply = async () => {
    if (!selectedMessage || !replyContent.trim()) {
      showToast("warning", "Please write a reply before sending");
      return;
    }

    try {
      showToast("info", "Sending your reply...");
      await axios.post(
      ...
      showToast("error", "Failed to send reply: " + (error.message || "Unknown error"));
    }
  };
      ...
      <div className="bg-white border-b border-gray-200 shadow-sm sticky top-0 z-10">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <Button
            ...
            onClick={() => {
              fetchMessages();
              showToast("info", "Refreshing messages...");
            }}
            disabled={refreshing}
          >
            <ArrowPathIcon
                ...
                <CardFooter className="pt-0 px-6 pb-6">
                  <Button
                    ...
                    onClick={() => {
                      ...
                      setOpenDialog(true);
                      showToast("info", `Replying to ${message.name}`);
                    }}
                  >
